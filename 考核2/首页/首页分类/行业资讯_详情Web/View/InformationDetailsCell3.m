...
@implementation InformationDetailsCell3

+(instancetype)createCellWithTableView:(UITableView *)tableView{
    [tableView registerNib:[UINib nibWithNibName:NSStringFromClass(InformationDetailsCell3.class) bundle:nil] forCellReuseIdentifier:NSStringFromClass(InformationDetailsCell3.class)];
    return [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(InformationDetailsCell3.class)];
}
...
- (void)awakeFromNib {
    ...
    self.contentImage.layer.cornerRadius = 4.0f;
