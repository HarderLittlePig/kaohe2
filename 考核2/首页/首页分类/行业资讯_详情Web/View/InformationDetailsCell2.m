...
@implementation InformationDetailsCell2

+(instancetype)createCellWithTableView:(UITableView *)tableView{
    [tableView registerNib:[UINib nibWithNibName:NSStringFromClass(InformationDetailsCell2.class) bundle:nil] forCellReuseIdentifier:NSStringFromClass(InformationDetailsCell2.class)];
    return [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(InformationDetailsCell2.class)];
}
