...
@implementation InformationDetailsCell1

+(instancetype)createCellWithTableView:(UITableView *)tableView{
    [tableView registerNib:[UINib nibWithNibName:NSStringFromClass(InformationDetailsCell1.class) bundle:nil] forCellReuseIdentifier:NSStringFromClass(InformationDetailsCell1.class)];
    return [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(InformationDetailsCell1.class)];
}
