//
//  InformationPersonalPageCell3.m
//  考核2
//
...
@implementation InformationPersonalPageCell3

+(instancetype)createCellWithTableView:(UITableView *)tableView{
    
    [tableView registerNib:[UINib nibWithNibName:NSStringFromClass(InformationPersonalPageCell3.class) bundle:nil] forCellReuseIdentifier:NSStringFromClass(InformationPersonalPageCell3.class)];
    return [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(InformationPersonalPageCell3.class)];
}
